...
void ProjectileAllocator::load()///load definitions of projectile types from a file
{
    ...
    (*data).texName = "textures/projectile/proj_1.png";
    (*data).animationFileName = "textures/projectile/proj_1.acfg";
    ...
    (*data).limitedToPhysDimensions = false;
    ...
    (*data).type = ClassType::GMODULE;
    (*data).shape = Shape::CIRCLE;
    (*data).texName = "textures/projectile/proj_2.png";
    (*data).animationFileName = "textures/projectile/proj_2.acfg";
    (*data).categoryBits = Category::Projectile;
    (*data).maskBits = Mask::ProjectileOff;
    (*data).isSensor = false;
    (*data).density = 0.1f;
